...
public class ItemIndustrialCellarDoor extends ItemBlock {

	public static final ResourceLocation INDUSTRIAL_CELLAR_DOOR = new ResourceLocation(Cellars.MODID, "item_industrial_cellar_door");
	
	public ItemIndustrialCellarDoor() {
		super(ModBlocks.industrialCellarDoor);
		setRegistryName(INDUSTRIAL_CELLAR_DOOR);
		setTranslationKey(Cellars.MODID + ".industrial_cellar_door");
	}
