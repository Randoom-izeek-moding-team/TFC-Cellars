...
public class ItemCellarDoor extends ItemBlock {

	public static final ResourceLocation CELLAR_DOOR = new ResourceLocation(Cellars.MODID, "item_cellar_door");
	
	public ItemCellarDoor() {
		super(ModBlocks.cellarDoor);
