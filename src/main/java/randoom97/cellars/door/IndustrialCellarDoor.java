...
public class IndustrialCellarDoor extends BlockDoor {

	public static final ResourceLocation INDUSTRIAL_CELLAR_DOOR = new ResourceLocation(Cellars.MODID, "industrial_cellar_door");
	
	public IndustrialCellarDoor() {
		super(Material.WOOD);
