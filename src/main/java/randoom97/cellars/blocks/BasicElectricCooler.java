...
public class BasicElectricCooler extends Block implements ITileEntityProvider {
	
	public static final ResourceLocation BASIC_ELECTRIC_COOLER = new ResourceLocation(Cellars.MODID, "basic_electric_cooler");
	
	public BasicElectricCooler() {
		super(Material.ROCK);
		setRegistryName(BASIC_ELECTRIC_COOLER);
		setTranslationKey(Cellars.MODID + ".basic_electric_cooler");
		setHardness(3.0F);
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileBasicElectricCooler();
	}
	
	@Override
	public void breakBlock(World world, BlockPos pos, IBlockState state) {
		TileEntity te = world.getTileEntity(pos);
		if(te instanceof TileBasicElectricCooler) {
